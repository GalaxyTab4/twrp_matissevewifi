...
/* TSP BOOSTER */
#if defined(CONFIG_SEC_E5_PROJECT) || defined(CONFIG_SEC_E7_PROJECT) || defined(CONFIG_SEC_MILLETVE_PROJECT) || defined(CONFIG_SEC_HESTIA2_PROJECT) \
	|| defined(CONFIG_SEC_DEGASVE_PROJECT) || defined(CONFIG_SEC_MATISSEVE_PROJECT)
