...
#define PRESSURE_FACTORY			0x85
	...
	defined(CONFIG_SENSORS_SSP_MAX88921) || \
...
#define MAX_ACCEL_1G	8191
#define MAX_ACCEL_2G	16383
#define MIN_ACCEL_2G	-16384
#define MAX_ACCEL_4G	32767
...
int ssp_iio_probe_trigger(struct ssp_data *, struct iio_dev *,
			struct iio_trigger *);
